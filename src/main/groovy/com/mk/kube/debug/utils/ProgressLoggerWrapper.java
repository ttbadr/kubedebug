...
public class ProgressLoggerWrapper {
     ...
     *
     * @param servicesOwner gradle task
     * @param desc          progress description
     * @throws ClassNotFoundException    if one of Gradle's internal classes could not be found
     * @throws NoSuchMethodException     if the interface of one of Gradle's internal classes has
     *                                   changed
     * @throws InvocationTargetException if a method from one of Gradle's internal classes could not
     *                                   be invoked
     * @throws IllegalAccessException    if a method from one of Gradle's internal classes is not
     *                                   accessible
     */
    public void init(Object servicesOwner, String desc) throws ClassNotFoundException,
    ...
    /**
     * Uses reflection to find a method with the given name and argument types from the given object
     * or its superclasses.
     *
    ...
    private void invokeIgnoreExceptions(Object obj, String method,
        ...
        try {
            ...
            logger.lifecycle("Unable to log progress", e);
        }
    }
